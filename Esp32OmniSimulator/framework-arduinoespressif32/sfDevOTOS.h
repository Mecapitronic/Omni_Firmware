...
class sfDevOTOS
{
  ...
  protected:
    ...
    // Conversion factors
    static constexpr float kMeterToInch = (float)(39.37f);
    static constexpr float kInchToMeter = (float)(1.0f / kMeterToInch);
    static constexpr float kRadianToDegree = (float)(180.0f / M_PI);
    static constexpr float kDegreeToRadian = (float)(M_PI / 180.0f);
    ...
    static constexpr float kMeterToInt16 = (float)(32768.0f / 10.0f);
    static constexpr float kInt16ToMeter = (float)(1.0f / kMeterToInt16);
    ...
    static constexpr float kMpsToInt16 = (float)(32768.0f / 5.0f);
    static constexpr float kInt16ToMps = (float)(1.0f / kMpsToInt16);
    ...
    static constexpr float kMpssToInt16 = (float)(32768.0f / (16.0f * 9.80665f));
    static constexpr float kInt16ToMpss = (float)(1.0f / kMpssToInt16);
    ...
    static constexpr float kRadToInt16 = (float)(32768.0f / M_PI);
    static constexpr float kInt16ToRad = (float)(1.0f / kRadToInt16);
    ...
    static constexpr float kRpsToInt16 = (float)(32768.0f / (2000.0f * kDegreeToRadian));
    static constexpr float kInt16ToRps = (float)(1.0f / kRpsToInt16);
    ...
    static constexpr float kRpssToInt16 = (float)(32768.0f / (M_PI * 1000.0f));
    static constexpr float kInt16ToRpss = (float)(1.0f / kRpssToInt16);
};
