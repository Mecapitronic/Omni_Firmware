...
CLEDController::CLEDController()
    : m_Data(NULL), m_ColorCorrection(UncorrectedColor),
      m_ColorTemperature(UncorrectedTemperature), m_nLeds(0)
{
    m_pNext = NULL;
    if (m_pHead == NULL)
    {
...
//    ColorAdjustment out = {
//        this->getAdjustment(brightness), this->getAdjustment(255), brightness};
//#else
