 ...
 */
inline esp_err_t ledc_channel_config(const ledc_channel_config_t *ledc_conf) { return ESP_OK; };
 ...
 */
inline esp_err_t ledc_timer_config(const ledc_timer_config_t *timer_conf) { return ESP_OK; };
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
inline esp_err_t ledc_update_duty(ledc_mode_t speed_mode, ledc_channel_t channel) { return ESP_OK; };
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
inline esp_err_t ledc_set_pin(int gpio_num, ledc_mode_t speed_mode, ledc_channel_t ledc_channel)
    __attribute__((deprecated("use ledc_channel_config instead"))) { return ESP_OK; };
/**
 * @brief LEDC stop.
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
inline esp_err_t ledc_stop(ledc_mode_t speed_mode, ledc_channel_t channel, uint32_t idle_level) { return ESP_OK; };
 ...
 *     - ESP_FAIL Can not find a proper pre-divider number base on the given frequency and the current duty_resolution.
 */
inline esp_err_t ledc_set_freq(ledc_mode_t speed_mode, ledc_timer_t timer_num, uint32_t freq_hz) { return ESP_OK; };
 ...
 */
inline uint32_t ledc_get_freq(ledc_mode_t speed_mode, ledc_timer_t timer_num) { return ESP_OK; };
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
inline esp_err_t ledc_set_duty_with_hpoint(ledc_mode_t speed_mode, ledc_channel_t channel, uint32_t duty, uint32_t hpoint) { return ESP_OK; };
 ...
 */
inline int ledc_get_hpoint(ledc_mode_t speed_mode, ledc_channel_t channel) { return ESP_OK; };
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
inline esp_err_t ledc_set_duty(ledc_mode_t speed_mode, ledc_channel_t channel, uint32_t duty) { return ESP_OK; };
 ...
 */
inline uint32_t ledc_get_duty(ledc_mode_t speed_mode, ledc_channel_t channel) { return ESP_OK; };
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error
 */
inline esp_err_t ledc_set_fade(ledc_mode_t speed_mode, ledc_channel_t channel, uint32_t duty, ledc_duty_direction_t fade_direction,
                        uint32_t step_num, uint32_t duty_cycle_num, uint32_t duty_scale) { return ESP_OK; };
 ...
 */
//inline esp_err_t ledc_isr_register(void (*fn)(void *), void *arg, int intr_alloc_flags, ledc_isr_handle_t *handle);
 ...
 */
inline esp_err_t ledc_timer_set(ledc_mode_t speed_mode, ledc_timer_t timer_sel, uint32_t clock_divider, uint32_t duty_resolution, ledc_clk_src_t clk_src) { return ESP_OK; };
 ...
 *     - ESP_OK Success
 */
inline esp_err_t ledc_timer_rst(ledc_mode_t speed_mode, ledc_timer_t timer_sel) { return ESP_OK; };
 ...
 *     - ESP_OK Success
 */
inline esp_err_t ledc_timer_pause(ledc_mode_t speed_mode, ledc_timer_t timer_sel) { return ESP_OK; };
 ...
 *     - ESP_OK Success
 */
inline esp_err_t ledc_timer_resume(ledc_mode_t speed_mode, ledc_timer_t timer_sel) { return ESP_OK; };
 ...
 *     - ESP_OK Success
 */
inline esp_err_t ledc_bind_channel_timer(ledc_mode_t speed_mode, ledc_channel_t channel, ledc_timer_t timer_sel) { return ESP_OK; };
 ...
 */
inline esp_err_t ledc_set_fade_with_step(ledc_mode_t speed_mode, ledc_channel_t channel, uint32_t target_duty, uint32_t scale, uint32_t cycle_num) { return ESP_OK; };
 ...
 *     - ESP_FAIL Fade function init error
 */
inline esp_err_t ledc_set_fade_with_time(ledc_mode_t speed_mode, ledc_channel_t channel, uint32_t target_duty, int max_fade_time_ms) { return ESP_OK; };
 ...
 */
inline esp_err_t ledc_fade_func_install(int intr_alloc_flags) { return ESP_OK; };

/**
 * @brief Uninstall LEDC fade function.
 */
inline void ledc_fade_func_uninstall(void) {};
 ...
 *     - ESP_ERR_INVALID_ARG Parameter error.
 */
inline esp_err_t ledc_fade_start(ledc_mode_t speed_mode, ledc_channel_t channel, ledc_fade_mode_t fade_mode) { return ESP_OK; };
 ...
 *      - ESP_FAIL Fade function init error
 */
inline esp_err_t ledc_set_duty_and_update(ledc_mode_t speed_mode, ledc_channel_t channel, uint32_t duty, uint32_t hpoint) { return ESP_OK; };
 ...
 *     - ESP_FAIL Fade function init error
 */
inline esp_err_t ledc_set_fade_time_and_start(ledc_mode_t speed_mode, ledc_channel_t channel, uint32_t target_duty, uint32_t max_fade_time_ms, ledc_fade_mode_t fade_mode) { return ESP_OK; };
 ...
 *     - ESP_FAIL Fade function init error
 */
inline esp_err_t ledc_set_fade_step_and_start(ledc_mode_t speed_mode, ledc_channel_t channel, uint32_t target_duty, uint32_t scale, uint32_t cycle_num, ledc_fade_mode_t fade_mode) { return ESP_OK; };
 ...
 *     - ESP_FAIL Fade function init error
 */
inline esp_err_t ledc_cb_register(ledc_mode_t speed_mode, ledc_channel_t channel, ledc_cbs_t *cbs, void *user_arg) { return ESP_OK; };
