...
class Motion
{
     ...
     ****************************************************************************************/
public:
    // delta time used for integration from acceleration to velocity, or velocity to
    // position => period of robot motion asserv
    ...
    float position_error;   // distance from current to end position (positive or negative
                            // distance)
